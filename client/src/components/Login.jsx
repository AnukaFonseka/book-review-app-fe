...
import googlrLogo from '../assets/google-logo.svg'
			...
			<div className="max-w-md mx-auto">
				...
				<form onSubmit={handleLogin} className="divide-y divide-gray-200">
					<div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                        ...
                        <p>If you do not have an acccount please <Link to="/sign-up" className='text-blue-600 underline'>Sign up</Link> Here </p>
                        <div className='relative'>
                ...
                <div className='flex w-full items-center flex-col mt-5 gap-3'>
                    <button onClick={handleRegister} className='block'><img src={googlrLogo} alt='google logo' className='w-12 h-12 inline-block'/>Login with Google</button>
                </div>
			</div>
		</div>
	</div>
